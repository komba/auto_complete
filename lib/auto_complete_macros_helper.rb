module AutoCompleteMacrosHelper      
  ...
  # It works for each item, not only for first
  # 
  def multi_text_field_with_auto_complete(object, method, tag_options = {}, completion_options = {})
	  ...
	  (completion_options[:skip_style] ? "" : auto_complete_stylesheet) + text_field(object, method, tag_options) +
